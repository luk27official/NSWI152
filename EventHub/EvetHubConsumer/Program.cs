...
namespace EvetHubConsumer
{
    ...
    {
        private const string EventHubConnectionString = "<REDACTED>"; // ie Endpoint=sb://XXX.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=XXX
        private const string EventHubName = "eventhub1"; // ie myeventhub1
