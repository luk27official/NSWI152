...
string keyVaultUrl = "https://keyvaultnswi152.vault.azure.net/";
...
KeyVaultSecret secret = await secretClient.GetSecretAsync("hi");
Console.WriteLine(secret.Value);

var keyClient = new KeyClient(vaultUri: new Uri(keyVaultUrl), credential);
var cryptographyClient = keyClient.GetCryptographyClient("mykey");

// encrypt the message with the key stored in Azure
